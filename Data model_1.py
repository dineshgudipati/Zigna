...
px_codes = pd.read_excel(r"D:\Zigna AI Corp\Zigna AI Corp - Hospital Application_2022-03-09\DRG refernce version 5\Tables for Data model\procedure_tables.xlsx", dtype=str)
mcc_codes = pd.read_excel("D:\Zigna AI Corp\Zigna AI Corp - Hospital Application_2022-03-09\DRG refernce version 5\Tables for Data model\mcc_reference_tables.xlsx")
cc_codes = pd.read_excel(r"D:\Zigna AI Corp\Zigna AI Corp - Hospital Application_2022-03-09\DRG refernce version 5\Tables for Data model\cc_reference_tables.xlsx")
drgs = pd.read_excel(r"D:\Zigna AI Corp\Zigna AI Corp - Hospital Application_2022-03-09\DRG refernce version 5\Tables for Data model\mcc_cc_non_mcc_cc.xlsx" ,converters={'drg':str})
dx_codes = pd.read_excel(r"D:\Zigna AI Corp\Zigna AI Corp - Hospital Application_2022-03-09\DRG refernce version 5\Tables for Data model\diagnosis_table.xlsx", dtype=str)
...
if claim1 != "nan":
    ...
    for index, x in dx_mdc.iteritems():
